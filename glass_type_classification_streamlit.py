...
def main():
    ...
    column_descriptions = {
        "RI": "Refractive Index",
        "Na": "Sodium (unit measurement: weight percent in corresponding oxide, as are all the other attributes)",
        "Mg": "Magnesium",
        "Al": "Aluminum",
        "Si": "Silicon",
        "K": "Potassium",
        ...
        "Ba": "Barium",
        "Fe": "Iron",
        "Type": "Type of glass (1: building_windows_float_processed, 2: building_windows_non_float_processed, 3: vehicle_windows_float_processed, 4: vehicle_windows_non_float_processed (none in this database), 5: containers, 6: tableware, 7: headlamps)"
    }
    ...
    if show_bivariate:
        ...
        fig = px.scatter(df, x=x_feature, y=y_feature, color='Type', title=f"{x_feature} vs {y_feature}")
        st.plotly_chart(fig, use_container_width=True)
